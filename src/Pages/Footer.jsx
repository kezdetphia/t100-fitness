    ...
    <div className="w-full h-full bg-customblackblack flex-row md:flex pt-5 ">
      ...
      <div className="flex items-center w-1/3 ">
        ...
        <div>
          ...
          <div>
            <p className="text-customgray pl-5 text-start  font-poppins text-sm leading-1 tracking-wide">
          ...
          <div className="w-full flex items-center p-5 space-x-4 ">
      ...
      {/* mid-div */}
      <div className="p-5 sm:pl-20 text-left">
        <h1 className="text-customwhite font-poppins font-bold text-lg sm:pb-3">
          Pages
        </h1>

        <div className="text-customgray flex sm:flex-col space-x-3 sm:space-x-0  sm:space-y-1 cursor-pointer ">
          <Link
            to={"banner"}
            spy={true}
            smooth={true}
