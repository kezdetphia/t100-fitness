  ...
  return (
    <div className="md:w-10/12">
      ...
      <div className="pt-3 m-3 px-2 flex ">
        <span className="top-0 left-0 font-family['SF_Compact_Display-Regular',Helvetica] font-normal text-[#999999] text-xl text-justify md:tracking-[0.1px] md:leading-[36px] leading-[30px]">
